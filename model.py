def prediction(stock, n_days):
    ...
    gsc = GridSearchCV(
        ...
        param_grid={'C': [0.001, 0.01, 0.1, 1, 100, 1000],'epsilon': [0.0001, 0.0005, 0.001, 0.005, 0.01, 0.05, 0.1, 0.5, 1, 5, 10,50, 100, 150, 100],'gamma': [0.0001, 0.001, 0.005, 0.1, 1, 3, 5, 8, 40, 100, 1000]},
        cv=5,
